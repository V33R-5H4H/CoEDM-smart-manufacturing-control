...
VALUES
    (
        101, 'asrs', 'CSG-SQR-70', 
        'Industrial 4-Bolt Square Flange Housing Unit (70×70mm, Ø40mm Bore)', 
    ...
    (
        102, 'asrs', 'CSG-OVL-40', 
        'Precision 2-Bolt Oval Flange Housing Unit (104mm, Ø40mm Bore)', 
    ...
    (
        ...
        'Precision Deep Groove Radial Ball Bearing (ABEC-5, Ø40mm OD × Ø18mm ID)', 
    ...
    (
        ...
        'Precision Ground Stepped Drive Shaft (EN8 Steel, L=120mm, Ø18mm)', 
    ...
    (
        ...
        'Aerospace-Grade 6061-T6 Aluminum Billet (80×80×40mm)', 
    ...
    (
        ...
        'High-Tensile EN8 Carbon Steel Solid Round Bar (Ø25mm × 200mm)', 
    ...
    (
        201, 'asrs', 'SVC-ASSY-PRESS', 
        'Precision Sub-Assembly Service (Station 2 Hydraulic Press)', 
        'Automated hydraulic press fitting, bearing alignment check, and ISO 9001 metrology certification at Station 2 CODESYS Hydraulic Press Cell.', 
        'finished', 'job', 450.00, '/images/bearing.png', NOW(), NOW()
    )
...
-- 2. Allocate inventory into ASRS compartments (box_id and sub_slot)
