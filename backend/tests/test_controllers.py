...
class TestBoxController:
    ...
    @patch("backend.crud.asrs.box.InventorySessionLocal")
    def test_get_all_boxes_returns_list(self, MockSession):
        ...
        from backend.crud.asrs.box import BoxController
...
class TestItemController:
    ...
    @patch("backend.crud.asrs.item.InventorySessionLocal")
    def test_get_all_items(self, MockSession):
        ...
        from backend.crud.asrs.item import ItemController
...
class TestSubCompartmentController:
    ...
    @patch("backend.crud.asrs.subcompartment.InventorySessionLocal")
...
class TestTransactionController:
    ...
    @patch("backend.crud.asrs.transaction.InventorySessionLocal")
...
class TestOrderController:
    ...
    @patch("backend.crud.asrs.order.InventorySessionLocal")
