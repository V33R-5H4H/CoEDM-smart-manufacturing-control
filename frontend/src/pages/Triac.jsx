            ...
            <div className="asm-center-container">
              ...
              <div className="asm-footer-stats">
                <div className="asm-footer-stats-card">
                  ...
                  <div className="asm-val__num" style={{ fontSize: "1.15rem", color: data?.status?.cycle_start ? "#4ade80" : !isConnected || !plcOnline ? "#475569" : "#64748b" }}>
                    {!isConnected || !plcOnline ? "---" : data.status.cycle_start ? "ACTIVE" : "STOPPED"}
                  </div>
                </div>
                <div className="asm-footer-stats-card">
                  <div className="asm-val__label">Coolant Pump</div>
                  <div className="asm-val__num" style={{ fontSize: "1.15rem", color: data?.status?.cycle_start ? "#38bdf8" : !isConnected || !plcOnline ? "#475569" : "#64748b" }}>
                ...
                <div className="asm-footer-stats-card">
                  ...
                  <div className="asm-val__num" style={{ fontSize: "1rem" }}>
                    {isConnected && plcOnline && data?.axes?.x?.feed != null ? Math.round(data.axes.x.feed) : "---"} <span className="asm-val__unit" style={{ fontSize: "0.75rem" }}>mm/m</span>
                  </div>
                </div>
                <div className="asm-footer-stats-card">
            ...
            >
              ...
              <div style={{ borderTop: "1px solid var(--border)", paddingTop: "10px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "8px" }}>
                  ...
                  <span style={{ fontSize: "0.75rem", color: "#64748b", fontWeight: 600 }}>TRANSVERSE</span>
                </div>
              ...
              <div style={{ borderTop: "1px solid var(--border)", paddingTop: "10px", marginTop: "8px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "8px" }}>
                  <span style={{ fontFamily: "'Orbitron', sans-serif", fontSize: "1rem", fontWeight: 800, color: "#4ade80" }}>Y</span>
                  <div style={{ flex: 1, height: "1px", background: "var(--border)" }} />
                  <span style={{ fontSize: "0.75rem", color: "#64748b", fontWeight: 600 }}>CROSS</span>
                </div>
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "8px" }}>
                  <div className="asm-val">
                    <div className="asm-val__label">Target Pos</div>
              ...
              <div style={{ borderTop: "1px solid var(--border)", paddingTop: "10px", marginTop: "8px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "8px" }}>
                  ...
                  <div style={{ flex: 1, height: "1px", background: "var(--border)" }} />
                  <span style={{ fontSize: "0.75rem", color: "#64748b", fontWeight: 600 }}>VERTICAL</span>
                </div>
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "8px" }}>
                  <div className="asm-val">
                    <div className="asm-val__label">Target Pos</div>
